...
const navigationMenuTriggerStyle = cva(
  "ygroup yinline-flex yh-10 yw-max yitems-center yjustify-center yrounded-md ybg-white ypx-4 ypy-2 ytext-sm yfont-medium ytransition-colors hover:ybg-slate-100 hover:ytext-slate-900 focus:ybg-slate-100 focus:ytext-slate-900 focus:youtline-none disabled:ypointer-events-none disabled:yopacity-50 data-[active]:ybg-slate-100/50 data-[state=open]:ybg-slate-100/50 dark:ybg-slate-950 dark:hover:ybg-slate-800 dark:hover:ytext-slate-50 dark:focus:ybg-slate-800 dark:focus:ytext-slate-50 dark:data-[active]:ybg-slate-800/50 dark:data-[state=open]:ybg-slate-800/50"
)
...
>(({ className, ...props }, ref) => (
  <div className={cn("yabsolute yleft-0 ytop-full yflex yjustify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "yorigin-top-center yrelative ymt-1.5 yh-[var(--radix-navigation-menu-viewport-height)] yw-full yoverflow-hidden yrounded-md yborder yborder-slate-200 ybg-white ytext-slate-950 yshadow-lg data-[state=open]:yanimate-in data-[state=closed]:yanimate-out data-[state=closed]:yzoom-out-95 data-[state=open]:yzoom-in-90 md:yw-[var(--radix-navigation-menu-viewport-width)] dark:yborder-slate-800 dark:ybg-slate-950 dark:ytext-slate-50",
        className
      )}
      ref={ref}
      {...props}
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="yrelative ytop-[60%] yh-2 yw-2 yrotate-45 yrounded-tl-sm ybg-slate-200 yshadow-md dark:ybg-slate-800" />
  </NavigationMenuPrimitive.Indicator>
))
